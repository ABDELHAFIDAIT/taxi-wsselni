...
Route::middleware(['auth'])->group(function(){
    ...
    Route::get('/disponibilites', function () {
        // return response()->json(Disponibility::all());

        // return response()->json(Disponibility::all()->map(function ($event) {
        //     return [
        //         'title' => 'Disponible', // Tu peux changer ça pour une valeur dynamique si besoin
        //         'start' => Carbon::parse($event->debut_disponibility)->toISOString(),
        //         'end' => Carbon::parse($event->fin_disponibility)->toISOString(),
